            ...
            <div className="col-12 col-lg-4">
                <div className="card text-center cardStyle">
                    <div className="card-body ">
                        ...
                        <Link to="/food" className="mt-3 btn cardStyle">See More</Link>
                    </div>
                </div>
            </div>
            <div className="col-12 col-lg-4 ">
                <div className="card text-center cardStyle" >
                    <div className="card-body ">
                        ...
                        <Link to="/penguins" className="btn cardStyle">See More</Link>
                    </div>
                </div>
            </div>
            <div className="col-12 col-lg-4">
                <div className="card text-center cardStyle">
                    <div className="card-body ">
                        ...
                        <Link to="/location" className="btn cardStyle">See More</Link>
                    </div>
                </div>
            </div>
        </div>
